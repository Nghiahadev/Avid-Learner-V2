...
>
  <div class="al-hero__inner">
    <h1 class="al-hero__title">Insights</h1>
    <div class="al-hero__divider"></div>
    <h2 class="al-hero__subtitle">Perspective that sharpens leaders and strengthens organizations </h2>
    <p class="al-hero__text">
      Actionable ideas, real-world experience, and practical tools to help you lead with clarity and drive meaningful impact. 
    </p>
  </div>
</section>
